...
export default class extends React.Component {
  ...
  render () {
    ...
    return <div className={ className }>
      ...
      <LayoutArea className={ css.Video } d={{ l: 0, t: 0, w: 960, h: 720 }} tip={ true } />
      <LayoutArea className={ css.Video } d={{ l: 960, t: 0, w: 960, h: 720 }} tip={ true } />

      <LayoutArea className={ css.TextRoll } d={{ l: 0, t: 990, w: 1920, h: 90 }}>
        <TextRoll />
      </LayoutArea>

      <LayoutArea d={{ l: 0, t: 810, w: 384, h: 180 }}>
        <Logo />
      </LayoutArea>

      <LayoutArea d={{ l: 1536, t: 810, w: 384, h: 180 }}>
        <AFDLogo />
      </LayoutArea>

      <LayoutArea d={{ l: 384, t: 810, w: 1152, h: 180 }}>
        <AFD />
      </LayoutArea>

      <LayoutArea d={{ l: 0, t: 720, w: 384, h: 90 }}>
        <div className={ css.Runner }>{ show.runner1 }</div>
      </LayoutArea>
      <LayoutArea d={{ l: 1536, t: 720, w: 384, h: 90 }}>
        <div className={ css.Runner }>{ show.runner2 }</div>
      </LayoutArea>

      <LayoutArea d={{ l: 384, t: 720, w: 384, h: 90 }}>
        <div className={ css.Game }>{ show.name }</div>
      </LayoutArea>
      <LayoutArea d={{ l: 1152, t: 720, w: 384, h: 90 }}>
        <div className={ css.Category }>{ show.category }</div>
      </LayoutArea>
      <LayoutArea d={{ l: 768, t: 720, w: 384, h: 90 }}>
