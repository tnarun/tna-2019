  ...
  render () {
    ...
    return <div className={ css.DAY }>
      ...
      <div className={ css.title }>
        ...
        {
          type === 'day' ? 
            <a href={ `/kksk2/live-layouts/day1` } target='_blank' rel='noopener noreferrer'>day1</a> :
            <a href={ `/kksk2/live-layouts/day2` } target='_blank' rel='noopener noreferrer'>day2</a>
        }
      </div>
      <div className={ css.title }>
        <span>鸣谢：</span>
