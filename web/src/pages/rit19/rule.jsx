...
const P1 = () => (
  ...
  <div className={ css.doc }>
    <IBox>
        ...
        　　正是由于追求如此极致的目标,所有位于排行榜前端的高端玩家所展示出来的,都是令人瞠目结舌、叹为观止、甚至一般玩家根本不可能用出来的高超技巧。也因为如此,在众多的的普通玩家、观众心中烙下了一个“速通都是用奇怪的技巧”“只有用 BUG 才能算速通”的印记。<br/><br/>

        　　实际上并不是这样的。<br/><br/>

        　　在竞速通关的世界里，只要遵守各个游戏社区所制定的规则、能够达成游戏与规则所设立的目的并正常计时且记录下来,他就是一个完整的 Speedrun. 不会有任何一个社区会要求、也不该用规则要求玩家“必须利用 BUG 或者特殊技巧完成游戏”。<br/><br/>

        　　虽然 speedrun 有着一份排行榜去竞争，但是速通的核心要义是“突破自我”。一款游戏从初见到通关，然后多次游戏渐渐熟悉游戏的风格与套路，尤其是在小时候游戏不多的时候，一款游戏打了很多遍，就会想出不同的花样去破关，速通也不过是其中的一种形式。<br/><br/>
