const days = [
  {
    name: 'day1',
    shows: [
      { id: 'd1-1', name: '开幕式', start: '12:00', end: '12:30' },
      ...
      { id: 'd1-5', name: 'SDVX4', runner: '耐科斯', category: 'Showcase', start: '17:15', end: '17:45' },
      { id: 'd1-6', name: '东方永夜抄', runner: 'LYX', category: 'Lunatic', start: '18:00', end: '18:35' },
  ...
  },
  {
    ...
    shows: [
      ...
      { id: 'd2-5', name: '健身环', runner: '美国游戏玩家大斯', category: '', start: '18:10', end: '19:10' },
      { id: 'd2-6', name: '马造2', runner: '水晶', category: '特定地图接力', start: '19:25', end: '20:25' },
